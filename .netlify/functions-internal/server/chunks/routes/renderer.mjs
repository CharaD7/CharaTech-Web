...
import { O as buildAssetsURL, H as useRuntimeConfig, P as getResponseStatusText, Q as getResponseStatus, R as defineRenderHandler, S as publicAssetsURL, a as getQuery, c as createError, T as destr, U as getRouteRules, V as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Modern platform for gathering software requirements"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"CharaTech - Software Requirements Platform"};
